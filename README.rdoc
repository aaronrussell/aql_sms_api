...
==== Send message
    ...
    #   destination can be single number or array of multiple numbers
    #   options can be has of :originator, :max_concat, :sendtime, :unix_sendtime, :replace_sms, :flash, :dlr_url
    #
